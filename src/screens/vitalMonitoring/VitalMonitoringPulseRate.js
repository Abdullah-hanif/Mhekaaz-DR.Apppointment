...
const VitalMonitoringPulseRate = ({ navigation }) => {
  const tableData = [
  ...
  return (
    <View style={styles.main}>
      ...
      <View style={styles.box}>
        <Text style={{ fontSize: 18, fontWeight: 'bold', left: 5 }}>Tempreture figures  <Text style={{ fontWeight: '400' }}>(By age)</Text></Text>
        <View
          style={{
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', padding: 10, margin: 5 }}>
          <View style={{ padding: 3, margin: 3 }}>
            <View><Text></Text></View>
            <Text style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', fontWeight: 'bold' }}><View style={{ height: 7, width: 7, backgroundColor: '#86705d', borderRadius: 20 }}></View> 18 -25</Text>
            <Text style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', fontWeight: 'bold' }}><View style={{ height: 7, width: 7, backgroundColor: '#d8b598', borderRadius: 20 }}></View> 18 -25</Text>
            <Text style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', fontWeight: 'bold' }}><View style={{ height: 7, width: 7, backgroundColor: '#f5e1d0', borderRadius: 20 }}></View> 18 -25</Text>
            <Text style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', fontWeight: 'bold' }}><View style={{ height: 7, width: 7, backgroundColor: '#e5c7ad', borderRadius: 20 }}></View> 18 -25</Text>
            <Text style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', fontWeight: 'bold' }}><View style={{ height: 7, width: 7, backgroundColor: '#e5c7ad', borderRadius: 20 }}></View> 18 -25</Text>

          </View>
          <View style={{ padding: 3, margin: 3 }}>
            <View><Text style={{ fontWeight: '600' }}>Good</Text></View>
          ...
          <View style={{ padding: 3, margin: 3 }}>
            <View><Text style={{ fontWeight: '600' }}>Normal</Text></View>
            <Text style={{ color: '#c4b8ad' }}>49-61</Text>
            <Text style={{ color: '#c4b8ad' }}>50-61</Text>
            <Text style={{ color: '#c4b8ad' }}>52-67</Text>
            <Text style={{ color: '#c4b8ad' }}>52-67</Text>
          ...
          <View style={{ padding: 3, margin: 3 }}>
            <View><Text style={{ fontWeight: '600' }}>Above</Text></View>
            <Text style={{ color: '#c4b8ad' }}>49-61</Text>
            <Text style={{ color: '#c4b8ad' }}>50-61</Text>
            <Text style={{ color: '#c4b8ad' }}>52-67</Text>
            <Text style={{ color: '#c4b8ad' }}>52-67</Text>
          ...
          <View style={{ padding: 3, margin: 3 }}>
            <View><Text style={{ fontWeight: '600' }}>Poor</Text></View>
            <Text style={{ color: '#c4b8ad' }}>61+</Text>
            <Text style={{ color: '#c4b8ad' }}>61+</Text>
            <Text style={{ color: '#c4b8ad' }}>67+</Text>
            <Text style={{ color: '#c4b8ad' }}>67+</Text>
            <Text style={{ color: '#c4b8ad' }}>67+</Text>
          </View>
...
export default VitalMonitoringPulseRate
